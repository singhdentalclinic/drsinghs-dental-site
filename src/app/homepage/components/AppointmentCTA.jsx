  ...
  return (
    <section className="py-6 md:py-8 lg:py-10">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <motion.div
          className="bg-gradient-to-br from-primary to-secondary rounded-2xl p-6 md:p-8 lg:p-12"
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <motion.div className="space-y-6 md:space-y-8" variants={staggerContainer(0.1)}>
              <motion.div
                variants={fadeInUp}
                className="inline-flex items-center space-x-2 px-4 py-2 bg-white/20 text-white rounded-full"
              >
              ...
              <motion.h2
                variants={fadeInUp}
                className="font-headline text-3xl md:text-4xl lg:text-5xl font-semibold text-white"
              >
                {ctaData?.title}
              </motion.h2>
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-white rounded-xl shadow-elevation-lg p-6 md:p-8"
            >
