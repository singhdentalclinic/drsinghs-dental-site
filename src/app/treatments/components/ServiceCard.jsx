...
export default function ServiceCard({ service }) {
  return (
    <div className="w-full min-w-0 bg-white relative z-10 rounded-lg border border-border/60 shadow-elevation-sm hover:shadow-elevation-lg transition-all duration-normal group">
