...
const TeethBleaching = () => {
    const benefits = [
        ...
        },
        {
            ...
            description: 'Break down intrinsic stains from aging, medication, or trauma that standard whitening cannot reach.',
            icon: 'BeakerIcon',
        },
        {
            title: 'Professional Supervision',
            description: 'Performed under expert care using clinical-grade agents for maximum safety and efficacy.',
            icon: 'ShieldCheckIcon',
        },
        {
            title: 'Long-Lasting Results',
            description: 'Deep-penetrating bleaching agents provide results that stay vibrant for much longer.',
            icon: 'ClockIcon',
        },
    ];
