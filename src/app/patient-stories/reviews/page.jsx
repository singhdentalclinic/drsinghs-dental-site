    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-20 mt-16">
                ...
                >
                    <Icon name="ArrowLeftIcon" size={18} className="transition-transform group-hover:-translate-x-1" />
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="font-body text-base md:text-lg text-text-secondary max-w-2xl mx-auto mb-8">
                        Real experiences from people who trusted us with their smiles. Join hundreds of satisfied patients at Singh Dental Clinic.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-8">
                        {['all', '5', '4', '3', '2', '1'].map((rating) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full font-body text-sm font-medium transition-all duration-300 border ${filterRating === rating
                        ...
                        {currentReviews.map((review, index) => (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${review.color} shrink-0`}>
                                ...
                                if (
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-lg font-body font-medium transition-all ${currentPage === pageNum
                ...
                <div className="mt-20 p-8 md:p-12 rounded-3xl bg-primary text-white text-center shadow-elevation-lg relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-blue-100 mb-8 max-w-xl mx-auto">
                            Dr. Pradeep Singh and his team are dedicated to providing the most comfortable dental experience in Ramnagar.
                        </p>
                        <Link
